...
export let productosEnOrden = [...productosNoEspeciales, ...productosEspeciales]
...
export let mercadosEnOrden = ["dia", "coto", "carrefour", "disco", "jumbo", "vea", "vital", "walmart"];
...
export let uniendoPrecios = [...preciosPorMercadoNoEspeciales, ...preciosEspeciales]
// console.log(preciosPorMercado)
