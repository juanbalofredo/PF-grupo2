...
const { routerPrice } = require("../routes/router.price.js");
const { routerSmarket } = require("../routes/router.smarket.js");
const { routerProducts } = require("../routes/router.products.js");
...
server.use("/smarket", routerSmarket)
